...
### App Description
Allows the users to create their own flashcard with awesome animations and styling.

### App Walk-though
![flashcard-app](lab4.gif)
...
![flashcard-app](http://g.recordit.co/URVSNm5LLG.gif)
